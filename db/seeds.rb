...
Actor.create!(first_name: "Harrison", last_name: "Ford", known_for: "Raiders of the Lost Ark", age: 79, gender: "male")

Actor.create!(first_name: "Daniel", last_name: "Craig", known_for: "Casino Royale", age: 53, gender: "male")

Actor.create!(first_name: "Matt", last_name: "Damon", known_for: "Good Will Hunting", age: 51, gender: "male")

Actor.create!(first_name: "Meryl", last_name: "Streep", known_for: "The Devil Wears Prada", age: 72, gender: "female")
...
# Movie.create!(title: "Atonement", year: 2007, plot: "English drama about a couple torn apart by a lie and war", director: "Joe Wright", english: "yes")

# Movie.create!(title: "Sweet Home Alabama", year: 2002, plot: "A New York fashion designer who finds herself engaged to an elligible bachelor must return home to Alabama to divorce the man she's already married to", director: "Andy Tennant", english: "yes")
